...
- **品質**: Vitest / Playwright / Biome / knip / madge / jscpd / type-coverage + 自前検査（`check:arch`, `check:sql-safety`, `docs:validate`, `size` = 初期 JS の brotli 合計 160 kB 予算）
...
- ユニット/API/Web テスト定義: <!-- stat:unit-tests -->726<!-- /stat --> 件
- Adapter conformance: <!-- stat:conformance -->174<!-- /stat --> 件 × 2 方言
- E2E: <!-- stat:e2e -->157<!-- /stat --> 件
- API ルート: <!-- stat:routes -->87<!-- /stat -->
