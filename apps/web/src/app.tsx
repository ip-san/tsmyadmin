...
/**
 * A 401 that means the session is gone (see `sessionExpired`) sends the user to the login page with a link back
 * to where they were. Several queries can fail in the same tick; only the first one navigates, so the redirect
 * target is the real page and not a nested /login URL.
 */
