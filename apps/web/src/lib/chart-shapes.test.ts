...
describe('time', () => {
  it('reads the dates and date-times a server returns, and nothing else', () => {
    ...
    expect(parseTime('2026-02-31')).toBeNull()
    expect(parseTime('2026-01-02 03:04:05+09')).toBe(Date.UTC(2026, 0, 1, 18, 4, 5))
    expect(parseTime('2026-01-02 03:04:05.5-05:30')).toBe(Date.UTC(2026, 0, 2, 8, 34, 5, 500))
